...
public class AIComponentMovementHover extends AIComponent{
	...
	public AIComponentMovementHover(String name) {
	...
	public boolean tick(Entity entity, float time, float deltaTime) {
		...
		if(entity.getAI().path == null) {
			EntityMovementUtil.hover(entity, time, deltaTime, null, posX, posY, posZ, maxTurn);
		...
		EntityMovementUtil.hover(entity, time, deltaTime, target, posX, posY, posZ, maxTurn);
